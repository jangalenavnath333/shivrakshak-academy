...
import {
  ...
  Dumbbell, MapPin, MessageCircle, Phone,
  Quote, ShieldCheck, Star, Target, Trophy, Users,
} from 'lucide-react'
...
export default async function HomePage() {
  ...
  return (
    <main className="landing-v2">
      ...
      <section className="v2-gallery" aria-labelledby="selected-heading">
        <div className="v2-gallery-head"><span>मेहनतीपासून निवडीपर्यंत</span><h2 id="selected-heading">आमचे निवडलेले विद्यार्थी</h2><p>ही सध्या design previewसाठी ठेवलेली placeholder gallery आहे. अकॅडमीचे खरे फोटो मिळाल्यावर याच जागी सहज बदलता येतील.</p></div>
        <div className="v2-gallery-photo" role="img" aria-label="निवड झालेल्या विद्यार्थ्यांची placeholder gallery" />
      </section>
