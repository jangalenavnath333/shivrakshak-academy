...
import { GraduationCap, Menu, Phone, ShieldCheck, X } from 'lucide-react'
  ...
  return (
    <header className="public-header">
      <div className="public-nav">
        ...
        <Link className="student-login-nav" href="/student/login"><GraduationCap size={17} /> Student Exam Login</Link>
      ...
      {open && <nav className="mobile-links">
        ...
        <Link href="/student/login" onClick={() => setOpen(false)}><GraduationCap size={17} /> Student Exam Login</Link>
