...
export async function PATCH(request: Request) {
  ...
  const lockedFields = ['course', 'duration_minutes', 'negative_marks', 'pass_marks', 'max_attempts'] as const
  ...
  if ((attemptCount || 0) > 0 && changesLockedExamData) {
    return NextResponse.json({ error: 'पहिला attempt सुरू झाल्यानंतर course, वेळ, गुणपद्धती किंवा attempts बदलता येत नाहीत. निकालाची वेळ व तारखा बदलता येतात.' }, { status: 409 })
  }
